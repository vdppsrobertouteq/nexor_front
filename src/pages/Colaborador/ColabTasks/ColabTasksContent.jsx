// File: frontend/src/pages/Colaborador/ColabTasks/ColabTasksContent.jsx
...
const ColabTasksContent = ({ project: propProject }) => {
    const { user } = useAuth();
    ...
    const handleGoToMeetings = () => {
        if (project) {
            ...
            navigate('/dashboard/colaborador/meetings', {
    ...
    const handleGoToDocuments = () => {
        if (project) {
            sessionStorage.setItem('selectedProject', JSON.stringify(project));
            navigate('/dashboard/colaborador/documents', {
                state: { project } // navegación inmediata sin recarga
            });
        } else {
            message.warning('No hay proyecto seleccionado');
...
export default ColabTasksContent;