// File: frontend/src/pages/Colaborador/ColabProjects/ColabProjectsContent.jsx
...
const ColabProjectsContent = ({ onProjectSelect }) => {
  ...
  const handleOpenProject = (project) => {
    ...
    if (onProjectSelect) {
      ...
      navigate('/dashboard/colaborador/tasks');
    }
  };
    ...
    <div className="projects-container">
      ...
      {projects.length === 0 && !loading && (
        <div className="no-projects">
          ...
          <Text>Aún no tienes proyectos asignados como colaborador.</Text>
        </div>
      )}
    </div>
  );
...
export default ColabProjectsContent;